...
public class InjectionTest
{
   ...
   public void testCarResource() throws Exception
   {
      ...
      String car = client.target("http://localhost:8080/services/cars/matrix/mercedes/e55;color=black/2006;test=oh!").request().get(String.class);
      System.out.println("http://localhost:8080/services/cars/matrix/mercedes/e55;color=black/2006");
      ...
      System.out.println("http://localhost:8080/services/cars/segment/mercedes/e55;color=black/2006");
      System.out.println(car);
      ...
      System.out.println("http://localhost:8080/services/cars/segments/mercedes/e55/amg/year/2006");
      System.out.println(car);

      System.out.println("**** CarResource Via PathSegment ***");
      car = client.target("http://localhost:8080/services/cars/uriinfo/mercedes/e55;color=black/2006").request().get(String.class);
      System.out.println("http://localhost:8080/services/cars/uriinfo/mercedes/e55;color=black/2006");
      System.out.println(car);
   }
